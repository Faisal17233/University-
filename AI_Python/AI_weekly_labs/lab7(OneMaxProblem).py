...
# It is the first step to create a genetic algo.
...
def create_toolbox(num_bits):
    ...
    # initialize the toolbox", tools.initRepeat, list, toolbox.individual)
...
if __name__ == "__main__":
    ...
    # evaluate the entire pouplation
    ...
    for g in range(num_generations):
        ...
        # print the statistics for the curerent generations
